...
public class Personnage {
    ...
    private final int LARGEUR_COLLISION = 20;
    private final int HAUTEUR_COLLISION = 32;

    // Paramètres physiques
    private double velociteY = 0;        // Vitesse verticale
    private final double GRAVITE = 0.6;  // Force de gravité
    private final double FORCE_SAUT = -10; // Force du saut (négatif car l'axe Y est vers le bas)
    ...
    // État du personnage
    private boolean auSol = false; // Commence en l'air
